...
const retryFunc = async(func, args, options) => {
  // args = [id, options, info]
  // funcs = [getWatchHTMLPage, getWatchJSONPage, getVideoInfoPage]
...
const findJSON = (source, varName, body, left, right, prependJSON) => {
  //source - 'watch.html'
  // varName - player_response
  // body - body
  // left - /\bytInitialPlayerResponse\s*=\s*\{/i
  // right - </script>
  // prependJSON - '{'
...
exports.getVideoInfoPage = getVideoInfoPage;
